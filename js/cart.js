...
function drowCartProductsUI(allProducts = []){
    let products = JSON.parse(localStorage.getItem("productsInCart")) || allProducts; // to return the last items in the array
    ...
    let productsUI = products.map( (item) => {
        ...
        <div class="product-item">
            ...
            <div class="product-item-actions">
                <button class="add-to-cart" onclick ="removeFromCart(${item.id})">Remove frme cart</button>
            </div>
        </div>
        `;
